...
server.tool("pw_list_articles", "Lista alla Patch Window-artiklar med metadata (utan fulltext). Kan filtreras på format och/eller tag.", {
...
server.tool("pw_get_article", "Hämta en fullständig Patch Window-artikel inklusive MDX-innehåll.", {
...
server.tool("pw_search", "Sök i Patch Window-artiklar på fritext. Söker i titel, excerpt och fulltext.", {
...
server.tool("pw_latest", "Hämta de senaste Patch Window-artiklarna sorterade efter publiceringsdatum.", {
...
server.tool("pw_list_tags", "Lista alla unika tags i Patch Window med antal artiklar per tag, sorterat fallande.", {}, async () => {
    const articles = await fetchArticles();
    const counts = {};
